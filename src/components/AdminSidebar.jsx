    ...
    <>
      ...
      >
        ...
        <div
          ...
          } fixed -right-8 top-1/2 transform py-12 px-2 -translate-y-1/2 block rounded-r-full cursor-pointer transition-transform duration-300 ease-in-out hover:scale-110`}
        >

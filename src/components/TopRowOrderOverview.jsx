    ...
    return (
        <>
            <div className='flex flex-col-reverse gap-2 w-64 md:w-full md:flex-row md:justify-between  mb-8'>
                <div>
                    <input type="text" name="searchForOrder" value={props.filteredOrders} onChange={(e) => { props.handleShowFilteredOrders(e) }} id="searchForOrderId" placeholder='Søg efter ordre...'></input>
                </div>

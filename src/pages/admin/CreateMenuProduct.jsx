...
function CreateMenuProduct() {
    ...
    const [checkedBreadTypes, setCheckedBreadTypes] = useState(
        new Array(breadTypes.length).fill(false)
    );

    const handleOnBreadtypeChange = (position) => {
        const updatedCheckedState = checkedBreadTypes.map((item, index) =>
    ...
    return (
        <PageWrapperContainer>
            ...
            <form ref={formRef} onSubmit={handleAddProduct}>
                ...
                <CustomInputWithLabel type="checkbox" CustomHandleChange={handleOnBreadtypeChange} CustomCheckedItems={checkedBreadTypes} CustomOptions={breadTypes} />
